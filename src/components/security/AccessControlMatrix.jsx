...
const rolePermissions = {
  ...
  institution: ['view_own_credentials', 'upload_credentials', 'issue_credentials', 'view_verification_history'],
  employer: ['verify_credentials', 'request_verification', 'view_verification_history'],
  admin: [
...
const roleColors = {
  ...
  institution: 'bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 border-indigo-500/20',
  employer: 'bg-cyan-500/10 text-cyan-400 hover:bg-cyan-500/20 border-cyan-500/20',
...
export default function AccessControlMatrix({ highlightRole, className }) {
  const roles = ['student', 'institution', 'employer', 'admin'];
