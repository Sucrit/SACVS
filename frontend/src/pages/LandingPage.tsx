...
// Removed Material Symbols Icon component — using Lucide icons instead
...
export default function LandingPage() {
  ...
  return (
    <div className="credence-font credence-page-bg relative flex min-h-screen w-full flex-col overflow-x-hidden text-neutral-900 antialiased">
      <header className="fixed inset-x-0 top-0 z-50 w-full px-4 py-4 md:px-10">
        <div className="mx-auto flex max-w-7xl items-center justify-between rounded-full border border-neutral-200/60 bg-white/60 px-5 py-3 shadow-[0_10px_28px_rgba(15,23,42,0.06)] backdrop-blur-xl md:px-7">
          <img alt="Credence logo" className="h-7 w-auto" src={logo2} />

          <nav className="hidden items-center gap-10 md:flex">
            <a className="text-sm font-medium text-neutral-600 transition hover:text-neutral-900" href="#features">
              Features
            </a>
            <a className="text-sm font-medium text-neutral-600 transition hover:text-neutral-900" href="#public-verify">
              Public Verify
            </a>
            <a className="text-sm font-medium text-neutral-600 transition hover:text-neutral-900" href="#solutions">
              Solutions
            </a>
            <a className="text-sm font-medium text-neutral-600 transition hover:text-neutral-900" href="#team">
              Team
            </a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            {!isSessionAuthenticated && (
              <>
                <Link
                  to="/auth/signin"
                  className="hidden h-9 items-center justify-center rounded-full px-4 text-sm font-medium text-neutral-600 transition-all hover:bg-neutral-100 hover:text-neutral-900 sm:flex"
                >
                  Sign In
                </Link>
                <Link
            ...
            {isSessionAuthenticated && (
              <>
                {isApprovedSession ? (
                  <Link
                    className="flex h-9 items-center justify-center rounded-full border border-neutral-200 px-4 text-sm font-medium text-neutral-700 transition-all hover:bg-neutral-100"
        ...
        <section className="credence-hero-gradient relative overflow-hidden pb-32 pt-40">
          <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-6 text-center md:px-20">
            ...
            <form
              ...
              className="w-full max-w-3xl rounded-lg border border-neutral-200/70 bg-white/70 p-3 shadow-[0_8px_25px_rgba(15,23,42,0.08)] backdrop-blur"
            >
              <div className="flex flex-col gap-2 md:flex-row">
                <input
                  ...
                  className="h-11 flex-1 rounded-lg border border-neutral-200 bg-white px-3 text-sm text-neutral-800 outline-none focus:border-neutral-300"
                />
                <button
                  type="submit"
                  ...
                  >
                    <div className="mb-6 inline-flex">
                      <div className="relative flex size-14 items-center justify-center rounded-lg border border-neutral-300 bg-white/90 shadow-[0_10px_25px_-14px_rgba(15,23,42,0.35)] transition-transform group-hover:scale-110">
                        <div className="absolute inset-[1px] rounded-2xl bg-gradient-to-br from-neutral-300/40 via-neutral-200/30 to-transparent"></div>
                        <FeatureIcon className="relative h-7 w-7 text-neutral-900" strokeWidth={2.2} />
                      </div>
                    </div>
                    <h3 className="mb-3 text-xl font-bold">{feature.title}</h3>
                    <p className="leading-relaxed text-neutral-500">{feature.description}</p>
                  </div>
                );
              })}
            </div>
              ...
              <article className="overflow-hidden rounded-[2rem] border border-[#2b3e52] bg-[#1b2a3a] shadow-[0_18px_44px_rgba(15,23,42,0.28)]">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="relative z-10 order-1 p-8 md:order-2 md:p-12 lg:p-14">
                    <p className="text-xs font-bold uppercase tracking-[0.15em] text-neutral-300">For Students</p>
                    ...
                    <a className="mt-8 inline-flex items-center gap-1 text-sm font-bold text-white hover:text-neutral-200" href="#">
                      View student access
      ...
      <footer id="team" className="border-t border-neutral-100 bg-neutral-50 px-6 pb-10 pt-20 md:px-20">
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
            <div className="col-span-2 lg:col-span-2">
              ...
              <div className="flex gap-4">
                <a
                  className="flex size-10 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-600 transition-all hover:bg-neutral-100 hover:text-neutral-900"
                  href="#"
                >
                  <Share2 size={18} />
                </a>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-neutral-500">
                {platformLinks.map(link => (
                  <li key={link}>
                    <a className="transition-colors hover:text-neutral-900" href="#">
                      {link}
                    </a>
                  </li>
                ))}
          ...
          <div className="flex flex-col items-center justify-between gap-6 border-t border-neutral-200 pt-10 md:flex-row">
            <p className="text-sm text-neutral-500">&copy; 2026 Credence. All academic rights reserved.</p>
            <div className="flex gap-8 text-xs font-bold  text-neutral-500">
