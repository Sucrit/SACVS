      ...
      {state.section === 'logs' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-neutral-900">Institution Audit Logs</h2>
          </div>
          <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            <div>
              <label className="mb-1 block text-xs font-semibold  text-neutral-500">Action</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold  text-neutral-500">Severity</label>
              <select
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold  text-neutral-500">Page Size</label>
              <select
